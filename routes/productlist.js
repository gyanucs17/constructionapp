...
router.post('/', auth, async (req, res, next) => {
    try {
        const toDo = await Todo.create({ title: req.body.title, mMaster: req.body.mMaster,
            Desc: req.body.Desc, crearedBy: req.user.id, htitle: req.body.htitle,
            image: req.body.image, mtype: req.body.mtype, rate: req.body.rate, 
...
router.get('/', auth, async(req, res, next) => {
    try {
        ...
        const todo = await Todo.find({mMaster: req.query.mMaster});
